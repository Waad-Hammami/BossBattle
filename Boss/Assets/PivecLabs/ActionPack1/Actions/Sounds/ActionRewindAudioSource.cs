namespace PivecLabs.ActionPack
{
	...
	[AddComponentMenu("")]
	public class ActionRewindAudioSource : IAction 
	{
		...
		public static new string NAME = "ActionPack2/Audio/Rewind AudioSource";
		private const string NODE_TITLE = "Rewind AudioSource";
