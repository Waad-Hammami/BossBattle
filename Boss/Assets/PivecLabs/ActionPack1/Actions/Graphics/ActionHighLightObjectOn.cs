namespace PivecLabs.ActionPack
{
	...
	public class ActionHighLightObjectOn : IAction
	{
        ...
        public override bool InstantExecute(GameObject target, IAction[] actions, int index)
        {
	        ...
	        renderers = TargetObject.GetComponentsInChildren<Renderer>();
	       	...
	       	foreach (var skinnedMeshRenderer in TargetObject.GetComponentsInChildren<SkinnedMeshRenderer>()) {
		...
		public static new string NAME = "ActionPack2/Graphics/HighLight Object On";
		private const string NODE_TITLE = "HighLight Object On";
  ...
  // INSPECTOR METHODS: ---------------------------------------------------------------------
        ...
        public override void OnInspectorGUI()
		{
			...
			EditorGUILayout.PropertyField(this.spTargetObject, new GUIContent("Object to HighLight"));
