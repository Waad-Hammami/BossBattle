namespace PivecLabs.ActionPack
{
    ...
    [AddComponentMenu("")]
	public class ActionFOVFollowCamera : IAction
    {
       ...
       // EXECUTABLE: ----------------------------------------------------------------------------
	    ...
	    public static new string NAME = "ActionPack2/Camera/FOV Follow Camera";
	    private const string NODE_TITLE = "FOV Follow Camera";
