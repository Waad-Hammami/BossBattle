namespace PivecLabs.ActionPack
{
    ...
    [AddComponentMenu("")]
	public class ActionTelePhotoAdvCamera : IAction
    {
       ...
       // EXECUTABLE: ----------------------------------------------------------------------------
	    ...
	    public static new string NAME = "ActionPack2/Camera/Telephoto Adventure Camera";
	    private const string NODE_TITLE = "Telephoto Adventure Camera";
