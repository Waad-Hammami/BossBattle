namespace PivecLabs.ActionPack
{
	...
	[AddComponentMenu("")]
	public class ActionSetSunColor : IAction
	{
        ...
        public override bool InstantExecute(GameObject target, IAction[] actions, int index)
        {
	        ...
	        {
		        DayNightManager.newSunColor = (Color)this.newColourVar.Get(target);
		        
	        }
	        else
	        {
		    	DayNightManager.newSunColor = (Color)newColourValue;
		...
		public static new string NAME = "ActionPack3/DayNight/Set Sun Color";
		private const string NODE_TITLE = "Set Sun Color";
