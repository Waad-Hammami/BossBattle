namespace PivecLabs.ActionPack
{
	...
	[AddComponentMenu("")]
	public class ActionSetAmbeintColorDay : IAction
	{
        ...
        public override bool InstantExecute(GameObject target, IAction[] actions, int index)
        {
	        ...
	        {
		        DayNightManager.newAmbientDay = (Color)this.newColourVar.Get(target);
		        
	        }
	        else
	        {
		    	DayNightManager.newAmbientDay = (Color)newColourValue;
		...
		public static new string NAME = "ActionPack3/DayNight/Set Ambient Color Daytime";
		private const string NODE_TITLE = "Set Ambient Color Daytime";
