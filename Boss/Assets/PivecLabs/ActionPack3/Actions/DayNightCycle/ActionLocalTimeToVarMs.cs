namespace PivecLabs.ActionPack
{
	...
	[AddComponentMenu("")]
	public class ActionLocalTimeToVarMs : IAction
    {
        ...
        public override bool InstantExecute(GameObject target, IAction[] actions, int index)
        {
	        ...
	        case FORMAT.String:
		        ...
		        this.storedString.Set(localtime.ToString());
		        break;
	        case FORMAT.Number:
			
		        this.storedNumber.Set(localtime);
		        break;
	        }
	    ...
	    public static new string NAME = "ActionPack3/DayNight/Local Millisecond to Variable";
	    private const string NODE_TITLE = "Local Millisecond to Variable";
