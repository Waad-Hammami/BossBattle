namespace PivecLabs.Tools
{
	...
	public class ActionToggleConsole : IAction
    {
        ...
        public override bool InstantExecute(GameObject target, IAction[] actions, int index)
        {
	        ...
	        if (showConsole == true)
	        {	        	
	        	consoleManager.GetComponent<InGameConsole>().showConsole = true;
	        }
	        else if (showConsole == false)
	        {
		        consoleManager.GetComponent<InGameConsole>().showConsole = false;
	    ...
	    public static new string NAME = "Developer Tools/Console/ToggleConsole";
	    private const string NODE_TITLE = "Toggle In-Game Console";
        ...
        public override void OnInspectorGUI()
            {
	            ...
	            EditorGUILayout.PropertyField(this.spconsoleManager, new GUIContent("Console Manager"));
